                ...
                <div className="relative z-10 flex flex-col lg:flex-row text-white justify-between items-center">
                    <div className="flex flex-col justify-center items-start lg:w-2/3">
                        ...
                        <p className="text-lg mt-4 font-thin leading-8">
                            <span className={"font-semibold"}>Software engineer</span> passionate about web development. <br/>
                            Interested in working together? <span className={"font-semibold"}>Let&apos;s get in touch!</span>
                            <br/>

                        </p>
                        <div className="flex justify-center space-x-4 mt-8">
                            <button className="btn btn-primary">Contact me <FontAwesomeIcon icon={faChevronRight}/>
                            </button>
