...
const services = [
    {
        ...
        description: "Offering both project-based work and long-term collaborations to meet your software needs.",
    },
    {
        icon: faCode,
...
const ServiceCard = ({icon, title, description}: { icon: any, title: string, description: string}) => (
    <div className="relative rounded-lg shadow-md border-2 text-center border-white border-opacity-5 w-96 px-6 pt-8 pb-24 transform transition-transform duration-300 hover:scale-105">
        ...
        <div className="absolute bottom-0 left-0 right-0 my-8 mx-16 flex justify-center items-center space-x-4">
            <span className={"opacity-10"}>&lt;h3&gt;</span>
...
export default function Services() {
    return (
        <section className="flex flex-col items-center justify-center w-full my-32">
